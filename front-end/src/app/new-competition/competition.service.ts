...
export class CompetitionService {
  ...
  add_draft(manager: string, endDate: Date, initialBudget: string, initialStock: string,
            refreshRate: string, numStocks: string, qs: string[]): Observable<any> {
    const body = JSON.stringify({managerId: manager, competitionEndDate: endDate,
  ...
  start_competition(manager: string, id: string, startDate: Date, endDate: Date, initialBudget: string,
                    initialStock: string, refreshRate: string, numStocks: string, qs: string[]): Observable<any> {
    const body = JSON.stringify({managerId: manager, competitionId: id, competitionStartDate: startDate,
      competitionEndDate: endDate, competitionMarketOpening: 0,
